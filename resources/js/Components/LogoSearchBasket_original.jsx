...
function LogoSearchBasket({auth}) {
    ...
    const fetchProductsInBasket = () => {
        const productIds = basketItems.map((item) => item.product_id);
    ...
    const handleRemoveItem = (index, item) => {
        axios.post('/basket/remove', {index: index, item:item})
            .then(response => {
            ...
            <div
                ...
                <div className="flex searchMargin">
                    <div>
                        <input
                            ...
                            onClick={fetchProducts} // Új rész hozzáadása
                ...
                >
                    <div className="flex relative mr-6">
                        ...
                        <span
                            className="bg-red-500 text-white border-1 border-black rounded-full p-1 flex items-center justify-content-center absolute top-0 right-0 -mt-2 -mr-2 w-6 h-6 z-10">
            {basketLength}
          </span>
                    </div>
                    <Button
                ...
                >
                    ...
                    {basketProducts && basketProducts.length === 0 ? (
                        ...
                        basketProducts.map((item, index) => (
                            totalPrice += item.price, // Ár hozzáadása az összeghez
                    ...
                    <div className="flex justify-content-end"><Button variant="danger" onClick={handleClearCart}
                                                                      className="border rounded-0 p-1">Kosár
                        ürítése</Button></div>
                </div>
            )}
        </>
